...
if ( !( $database = mysqli_connect( "bur.ccg2fbosv7le.us-west-2.rds.amazonaws.com:3306",
      "bmaple", "security", "Bureaucrat" ) ) )
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <div class="navbar-brand">Bureaucrat File Management</div>
            </div>
            <!-- Top Menu Items -->
